...
use EasyUtils\Forward\Service\Proxy\CollectdataProxyFactory;
use EasyUtils\Forward\Service\Proxy\GeneralProxyFactory;
use EasyUtils\Forward\Service\Proxy\module\IBookProxy;
use EasyUtils\Forward\Service\Proxy\module\IBrProxy;
...
//     private static $allowedFamalies = ['general'];
     ...
     * @return mixed|\EasyUtils\Forward\Service\Proxy\module\impl_general\ToolProxy
     */
