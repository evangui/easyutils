...
use EasyUtils\Mq\Service\SimpleMq;
...
class SimpleConsumeServer extends Command
{
    protected function configure()
    {
        // 指令配置
        $this->setName('simple_consume_server');
        // 设置参数
        $this
            ->addArgument('channel', Argument::REQUIRED, "channel")
            ->setDescription('simple consume queue message ');
    }
